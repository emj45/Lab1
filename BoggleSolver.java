	...
	private void solve(int row, int col, /*for debugging*/ int depth){
		...
		for(int direction=0; direction<8; direction++){
			if(isValid(row, col, direction)){
				...
				theBoard[nextCoordinates.row][nextCoordinates.col] =
					Character.toUpperCase(theBoard[nextCoordinates.row][nextCoordinates.col]);
				...
				theBoard[nextCoordinates.row][nextCoordinates.col] =
					Character.toLowerCase(theBoard[nextCoordinates.row][nextCoordinates.col]);
			}
